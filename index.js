...
function onData(dato){
    ...
    var ejex= 0,ejey= 0,ejez= 0,temp= 0,cordenadax= 0,cordenaday= 0;
    let contador = 0;
    ...
    // contador++;
    // while(dato[contador]!=','){
    //     temp = temp + (dato[contador]);
    // }
    // contador++;
    // while(dato[contador]!=','){
    //     cordenadax = cordenadax + (dato[contador]);
    // }
    // contador++;
    // while(dato[contador]!=','){
    //     cordenaday = cordenaday + (dato[contador]);
    // }
